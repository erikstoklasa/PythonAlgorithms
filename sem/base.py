...
class BasePlayer:
    def __init__(self, board, playerName, myColor):
        ...
        self.algorithmName = (
            "Trax master"  # name of the algorithm, will be shown in tournament
        )
        ...
        self.rivalColor = {
            "l": "d",
            "d": "l",
        }  # rival's color is self.rivalColor[self.myColor]
        self.tiles = [
            "lldd",
            "dlld",
            "ddll",
        ...
        self.my2other = [
            ...
            0,
            1,
        ]  # my side '0' points to 2, my side '1' points to 3 etc..
